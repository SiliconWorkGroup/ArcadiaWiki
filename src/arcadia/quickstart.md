...
| 分支 | 特点 | 适合 |
| :----- | :------ | :------ |
| **Next（1.20.1 Forge）** | 更成熟稳定，模组数量多 | 稳定游玩首选 |
| **nextStage（1.21.1 NeoForge）** | 更新技术栈，新特性更多 | 喜欢尝鲜的玩家 |
...
A: 尝试分配更多的内存（在启动器设置中找到内存滑块，调高分配量）；检查是否安装了 Java 17。
...
A: 如果你是第一次接触 theArcadia，推荐 **1.20.1 Next**——模组生态更成熟，问题更少。
